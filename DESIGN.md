...
- A shared 1200 px outer container aligns navigation, page headers and content. Interior pages use explicit columns or content groups, with readable text measures inside them. They do not reduce the whole page to a narrow reading strip. Columns stack on small screens in the same document order.
