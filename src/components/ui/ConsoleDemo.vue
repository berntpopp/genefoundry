...
const lines: Line[] = [
  ...
  { tokens: [{ t: '→ 4 matches · 2 servers · ranked by BM25', c: 'text-slate-500' }] },
  { indent: 1, tokens: [{ t: 'gnomad_search_genes', c: 'text-primary-light' }, { t: '  gnomad', c: 'text-sky-300' }, { t: ' · variant·frequency', c: 'text-slate-600' }] },
  { indent: 1, tokens: [{ t: 'gnomad_resolve_variant_id', c: 'text-primary-light' }, { t: '  gnomad', c: 'text-sky-300' }, { t: ' · variant', c: 'text-slate-600' }] },
  { indent: 1, tokens: [{ t: 'gtex_get_median_expression', c: 'text-primary-light' }, { t: '  gtex', c: 'text-sky-300' }, { t: ' · expression', c: 'text-slate-600' }] },
  { tokens: [{ t: '', c: '' }] },
  ...
  { indent: 2, tokens: [{ t: '"symbol"', c: 'text-violet-300' }, { t: ': ', c: 'text-slate-500' }, { t: '"PKD1"', c: 'text-emerald-300' }, { t: ',', c: 'text-slate-500' }] },
  { indent: 2, tokens: [{ t: '"af_popmax"', c: 'text-violet-300' }, { t: ': ', c: 'text-slate-500' }, { t: '0.000042', c: 'text-amber-300' }, { t: ',', c: 'text-slate-500' }] },
  { indent: 2, tokens: [{ t: '"source"', c: 'text-violet-300' }, { t: ': ', c: 'text-slate-500' }, { t: '"gnomAD v4.1"', c: 'text-emerald-300' }, { t: ',', c: 'text-slate-500' }] },
  { indent: 2, tokens: [{ t: '"cited"', c: 'text-violet-300' }, { t: ': ', c: 'text-slate-500' }, { t: 'true', c: 'text-emerald-400' }] },
  { indent: 1, tokens: [{ t: '}', c: 'text-slate-500' }] },
]
...
<template>
  ...
  >
    ...
    <div class="flex items-center justify-between border-b border-white/10 px-4 py-2.5">
      ...
      <span class="font-mono text-[11px] uppercase tracking-[0.18em] text-slate-500">genefoundry · mcp</span>
    </div>
