    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-3xl text-center">
        ...
        <p class="mt-5 text-lg leading-relaxed text-slate-400">
          A client to each backend, a server to your host. GeneFoundry shapes the surface without
          standing between your agent and the evidence.
        </p>
      </div>
      ...
      <div class="mt-14 grid gap-3.5 lg:grid-cols-3">
        <article
          ...
          :class="[
            f.span,
            f.featured
              ? 'bg-gradient-to-br from-primary/[0.12] via-accent/[0.06] to-transparent'
              : 'bg-panel/50'
          ]"
        >
          <div
            class="mb-4 flex h-11 w-11 items-center justify-center rounded-xl border border-white/10 bg-white/[0.05] text-primary-light"
          >
        ...
        >
          <div class="flex items-start gap-4">
            <div
              class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.05] text-primary-light"
            >
            ...
            <div>
              ...
              <p class="mt-1 max-w-2xl text-sm leading-relaxed text-slate-400">
                A ~600-LOC FastMCP 3.x router: config-driven, mypy-strict, tested. Self-host it or
                use the hosted endpoint. Read the code, file an issue, add a server.
              </p>
            </div>
          </div>
          <a
